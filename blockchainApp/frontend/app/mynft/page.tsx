...
const contractAddress = '0x518b8c9BE21878991A11b764d9055aA3d88f55d9';
...
export default function MyNFT() {
  ...
  const handleButtonClick = async () => {
    ...
    try {
      ...
      await myERC721Contract?.safeMint(account, 'https://gateway.pinata.cloud/ipfs/QmVSPrDxWvq9atqfBxtT3zFuzzern9czR44sqzuuCDeaNv');
      // 成功した場合はアラートを表示する
      setShowAlert(true);
  ...
  const seaportAddress = "0xD0f3BD2c9db1b4E7E8D9dcDE3D4567AE9e486E97";
